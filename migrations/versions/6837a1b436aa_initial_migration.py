...
Revision ID: 6837a1b436aa
Revises: 
Create Date: 2020-10-08 22:47:48.714676
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('page_id'),
    sa.UniqueConstraint('uuid', 'id', name='unique_catalog_categories')
    )
    ...
    sa.UniqueConstraint('uuid', 'id', name='unique_category_items')
    )
